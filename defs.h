...
#define DISTANCE_ECHO_GPIO_PIN GPIO_PIN_7
#define DISTANCE_ECHO_GPIO GPIOB

#define DISTANCE_TIM TIM4
#define DISTANCE_TIM_CLK_ENABLE __HAL_RCC_TIM4_CLK_ENABLE
#define DISTANCE_TIM_CHANNEL_GPIO_PORT       __HAL_RCC_GPIOB_CLK_ENABLE
